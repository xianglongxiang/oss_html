...
(function(w,$){
    ...
    var home = {
        ...
        "createTable":function(){
            ...
            //初始化列表 serverSide=false 表示不使用服务器处理
            tb = SJTable.table.init("#grid",config.path+"js/page/table/datatable/data/tb.json", data, columns, {"orderArr":orderArr, "callback":showDetail,"columnDefs":columnDefs,"serverSide":false});
        },
