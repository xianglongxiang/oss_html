...
var Alertify = (function(global, undefined) {
    ...
    Alertify = function() {
         ...
         */
        var dialogs = {
//            title:"<h4  class='alertify-title'>{{title}}<a class='close alertify-close'></a></h4>",
            title:"<h4  class='alertify-title'>{{title}}</h4>",
            buttons: {
        ...
        var _alertify = {
            ...
            build: function(item) {
                ...
                var html = "<div class='alertify-dialog'>" + "<div class='alertify-inner'>" +dialogs.title.replace("{{title}}",item.title)+ dialogs.message.replace("{{message}}", item.message);
            ...
            close: function(elem, wait) {
                ...
                if (this.closeLogOnClick) {
                    ...
                    aElem.className += "close alertify-close";
                    var p =document.createElement("p");
                    p.innerHTML = elem.innerHTML;
                    elem.innerHTML = "";
                    elem.appendChild(aElem);
                    elem.appendChild(p);
                   // elem.innerHTML = aElem +elem.innerHTML;
             ...
             * @return {Object}
             */
            dialog: function(title,message, type, onOkay, onCancel) {
            ...
            okBtn: function(label) {
                this.okLabel = label||_alertify.defaultOkLabel;
                return this;
            },
            ...
            cancelBtn: function(str) {
              this.cancelLabel = str||_alertify.defaultCancelLabel;
              return this;
            },
        ...
        return {
            ...
            alert: function(message, onOkay, onCancel,title) {
                _alertify.dialog(title||"操作",message, "alert", onOkay, onCancel);
                return this;
            },
            confirm: function(message, onOkay, onCancel,title) {
                _alertify.dialog(title||"操作",message, "confirm", onOkay, onCancel);
                return this;
            },
            prompt: function(message, onOkay, onCancel,title) {
                _alertify.dialog(title||"操作",message, "prompt", onOkay, onCancel);
                return this;
            },
