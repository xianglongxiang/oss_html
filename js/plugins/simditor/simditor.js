...
Formatter = (function(_super) {
  ...
  Formatter.prototype._init = function() {
    ...
    this._allowedAttributes = {
      img: ['src', 'alt', 'width', 'height', 'page-image-src', 'page-image-size', 'page-image-name', 'page-non-image'],
      a: ['href', 'target'],
      font: ['color'],
      pre: ['page-lang', 'class'],
      p: ['page-indent'],
...
Util = (function(_super) {
  ...
  Util.prototype.indent = function() {
    ...
    if ($blockEl.is('pre')) {
      ...
      indentLevel = (_ref = $blockEl.attr('page-indent')) != null ? _ref : 0;
      indentLevel = indentLevel * 1 + 1;
      if (indentLevel > 10) {
        indentLevel = 10;
      }
      $blockEl.attr('page-indent', indentLevel);
...
ColorButton = (function(_super) {
  ...
  ColorButton.prototype.renderMenu = function() {
    $('<ul class="color-list">\n  <li><a href="javascript:;" class="font-color font-color-1" page-color=""></a></li>\n  <li><a href="javascript:;" class="font-color font-color-2" page-color=""></a></li>\n  <li><a href="javascript:;" class="font-color font-color-3" page-color=""></a></li>\n  <li><a href="javascript:;" class="font-color font-color-4" page-color=""></a></li>\n  <li><a href="javascript:;" class="font-color font-color-5" page-color=""></a></li>\n  <li><a href="javascript:;" class="font-color font-color-6" page-color=""></a></li>\n  <li><a href="javascript:;" class="font-color font-color-7" page-color=""></a></li>\n  <li><a href="javascript:;" class="font-color font-color-default" page-color=""></a></li>\n</ul>').appendTo(this.menuWrapper);
...
CodePopover = (function(_super) {
  ...
  CodePopover.prototype.render = function() {
    ...
    return this.selectEl.on('change', (function(_this) {
      return function(e) {
        ...
        _this.target.removeClass().removeAttr('page-lang');
        if (_this.lang !== -1) {
          _this.target.addClass('lang-' + _this.lang);
          _this.target.attr('page-lang', _this.lang);
        }
        if (selected) {
  ...
  CodePopover.prototype.show = function() {
    ...
    this.lang = this.target.attr('page-lang');
    if (this.lang != null) {
...
ImageButton = (function(_super) {
  ...
  ImageButton.prototype._init = function() {
    ...
    this.editor.body.on('click', 'img:not([page-non-image])', (function(_this) {
      return function(e) {
        var $img, range;
        $img = $(e.currentTarget);
        range = document.createRange();
    ...
    this.editor.body.on('mouseup', 'img:not([page-non-image])', (function(_this) {
      return function(e) {
        return false;
      };
    })(this));
    this.editor.on('selectionchanged.image', (function(_this) {
      return function() {
        ...
        if ($contents.length === 1 && $contents.is('img:not([page-non-image])')) {
...
TableButton = (function(_super) {
  ...
  TableButton.prototype._initShortcuts = function() {
    this.editor.inputManager.addShortcut('ctrl+alt+up', (function(_this) {
      return function(e) {
        _this.editMenu.find('.menu-item[page-param=insertRowAbove]').click();
        return false;
      };
    })(this));
    this.editor.inputManager.addShortcut('ctrl+alt+down', (function(_this) {
      return function(e) {
        _this.editMenu.find('.menu-item[page-param=insertRowBelow]').click();
        return false;
      };
    })(this));
    this.editor.inputManager.addShortcut('ctrl+alt+left', (function(_this) {
      return function(e) {
        _this.editMenu.find('.menu-item[page-param=insertColLeft]').click();
        return false;
      };
    })(this));
    return this.editor.inputManager.addShortcut('ctrl+alt+right', (function(_this) {
      return function(e) {
        _this.editMenu.find('.menu-item[page-param=insertColRight]').click();
        return false;
      };
    })(this));
  };
  ...
  TableButton.prototype.renderMenu = function() {
    $("<div class=\"menu-create-table\">\n</div>\n<div class=\"menu-edit-table\">\n  <ul>\n    <li><a tabindex=\"-1\" unselectable=\"on\" class=\"menu-item\" href=\"javascript:;\" page-param=\"deleteRow\"><span>" + (this._t('deleteRow')) + " ( Ctrl + Alt + → )</span></a></li>\n    <li><a tabindex=\"-1\" unselectable=\"on\" class=\"menu-item\" href=\"javascript:;\" page-param=\"insertRowAbove\"><span>" + (this._t('insertRowAbove')) + " ( Ctrl + Alt + ↑ )</span></a></li>\n    <li><a tabindex=\"-1\" unselectable=\"on\" class=\"menu-item\" href=\"javascript:;\" page-param=\"insertRowBelow\"><span>" + (this._t('insertRowBelow')) + " ( Ctrl + Alt + ↓ )</span></a></li>\n    <li><span class=\"separator\"></span></li>\n    <li><a tabindex=\"-1\" unselectable=\"on\" class=\"menu-item\" href=\"javascript:;\" page-param=\"deleteCol\"><span>" + (this._t('deleteColumn')) + "</span></a></li>\n    <li><a tabindex=\"-1\" unselectable=\"on\" class=\"menu-item\" href=\"javascript:;\" page-param=\"insertColLeft\"><span>" + (this._t('insertColumnLeft')) + " ( Ctrl + Alt + ← )</span></a></li>\n    <li><a tabindex=\"-1\" unselectable=\"on\" class=\"menu-item\" href=\"javascript:;\" page-param=\"insertColRight\"><span>" + (this._t('insertColumnRight')) + " ( Ctrl + Alt + → )</span></a></li>\n    <li><span class=\"separator\"></span></li>\n    <li><a tabindex=\"-1\" unselectable=\"on\" class=\"menu-item\" href=\"javascript:;\" page-param=\"deleteTable\"><span>" + (this._t('deleteTable')) + "</span></a></li>\n  </ul>\n</div>").appendTo(this.menuWrapper);
