...
;(function($, window, document, undefined) {
	...
	Tree.prototype = {
		...
		// page attribute nodeid, which is used to lookup the node in the flattened structure.
		_findNode: function(target) {

			var nodeId = target.closest('li.list-group-item').attr('page-nodeid'),
		...
		// 1. selectedNode
		// 2. node|page assigned color overrides
